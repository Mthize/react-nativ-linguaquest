...
- Use Expo app config extras with expo-constants for PostHog config in managed apps, not react-native-config
- In `app.config.js`, prefix public environment variables with `EXPO_PUBLIC_` and map them into `expo.extra`
